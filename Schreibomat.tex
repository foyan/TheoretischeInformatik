...
\begin{enumerate}
\item $\hat\delta(q_0, \epsilon) = \varepsilon$-Hülle$(q_0) = \{q_0, q_1 \}$
...
\draw (24.05,-16.7) node [below] {$\epsilon$};
\end{tikzpicture}
\end{center}
...
\draw (42.4,-17.8) node [below] {$\epsilon$};
\end{tikzpicture}
\end{center}
...
\draw (29.15,-9.34) node [above] {$\epsilon$};
\draw [black] (14.1,-17.3) -- (18.8,-17.3);
\fill [black] (18.8,-17.3) -- (18,-16.8) -- (18,-17.8);
\draw (16.45,-17.8) node [below] {$\epsilon$};
...
\draw (50.1,-23.3) node [below] {$\epsilon$};
\draw [black] (7.2,-22.8) -- (10.2,-22.8);
\fill [black] (10.2,-22.8) -- (9.4,-22.3) -- (9.4,-23.3);
\draw (8.7,-23.3) node [below] {$\epsilon$};
...
\draw (59.25,-23.3) node [below] {$\epsilon$};
...
\draw (58.15,-24.8) node [below] {$\epsilon$};
...
\draw (41.25,-4.18) node [above] {$\epsilon$};
\draw [black] (70.2,-27.3) -- (70.2,-30.9);
\fill [black] (70.2,-30.9) -- (70.7,-30.1) -- (69.7,-30.1);
\draw (69.7,-29.1) node [left] {$\epsilon$};
\draw [black] (7,-24.3) -- (9.3,-24.3);
\fill [black] (9.3,-24.3) -- (8.5,-23.8) -- (8.5,-24.8);
\draw (8.15,-24.8) node [below] {$\epsilon$};
...
\draw (34.65,-44.34) node [below] {$\epsilon$};
\end{tikzpicture}
\end{center}
...
\draw (20.77,-31.8) node [below] {$\epsilon$};
...
\draw (44.42,-44.69) node [below] {$\epsilon$};
\draw [black] (42.48,-50.87) -- (46.12,-48.73);
\fill [black] (46.12,-48.73) -- (45.17,-48.7) -- (45.68,-49.56);
\draw (45.22,-50.3) node [below] {$\epsilon$};
\draw [black] (20.502,-45.542) arc (-127.10424:-356.91386:24.36);
